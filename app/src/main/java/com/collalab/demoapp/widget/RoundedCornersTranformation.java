...
public class RoundedCornersTranformation implements Transformation<Bitmap> {
    ...
    public RoundedCornersTranformation(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public RoundedCornersTranformation(BitmapPool pool, int radius, int margin) {
